...
const Footer = () => {
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} w-full md:flex-row flex-1 flex-col mb-8`}>
        <div className="flex-1 flex flex-col justify-start mr-10">
          <img src={logo} alt="logo" className="w-[260px] h-[72px] object-contain" />
          <p className={`${styles.paragraph} mt-4 max-w-[310px]`}>An innovation on online payments, made easy, reliable and secure.</p>
        </div>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
        <p className="font-[poppins] font-normal text-center text-[18px] leading-[27px] text-white">Copyright Ⓒ 2025 IsaacBank. All Rights Reserved.</p>
